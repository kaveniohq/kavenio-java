...
public class CreateProfileRequest {
  ...
  public CreateProfileRequest name(@jakarta.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public CreateProfileRequest description(@jakarta.annotation.Nullable String description) {
  ...
  public CreateProfileRequest color(@jakarta.annotation.Nullable String color) {
    this.color = color;
    return this;
  }
  ...
  public CreateProfileRequest isDefault(@jakarta.annotation.Nullable Boolean isDefault) {
   ...
   * @return the CreateProfileRequest instance itself
   */
  public CreateProfileRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, createProfileRequest.name) &&
        ...
        Objects.equals(this.isDefault, createProfileRequest.isDefault)&&
        Objects.equals(this.additionalProperties, createProfileRequest.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateProfileRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CreateProfileRequest is not found in the empty JSON string", CreateProfileRequest.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<CreateProfileRequest>() {
           ...
           public CreateProfileRequest read(JsonReader in) throws IOException {
             ...
             CreateProfileRequest instance = thisAdapter.fromJsonTree(jsonObj);
